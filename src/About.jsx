...
function About() {
  ...
  const additionalText = ` Over the past 2 years, I've worked on multiple projects ranging from portfolio websites, 
  to-do apps, and API-based web apps. I am also skilled in UI/UX design, which allows me to approach projects holistically.`;
  ...
  return (
    <section className="w-11/12 mx-auto mt-6 bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg">
      ...
      <ul className="grid grid-cols-2 sm:grid-cols-3 gap-6 mb-6">
        <li className="flex flex-col items-center justify-center p-4 bg-gray-50 dark:bg-gray-700 
        text-gray-800 dark:text-white rounded-xl shadow-md hover:shadow-xl transition">
